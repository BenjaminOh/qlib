    ...
    <article className="max-w-none space-y-6">
      ...
      <Step n="5" title="매도 기준">
        <ul className="list-disc pl-6 text-gray-700 text-sm space-y-1.5">
          ...
          <li className="text-gray-500">예외 — <strong>종가 매수 시뮬(close)</strong>은 2026-08-03부터 별도 규칙 실험 중:
            신호 이탈 매도 없이 <strong>평균단가 대비 ±5% 도달 시에만 익절/손절</strong> (당일 고가/저가로 판정, 양쪽 동시 터치 시 손절 우선 가정)</li>
        </ul>
      </Step>
